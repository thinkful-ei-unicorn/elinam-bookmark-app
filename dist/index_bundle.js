          ...
          d = function () {
            $("main").on("click", ".new", function () {
              ...
              $("main").on("change", ".ratings", function () {
                (o.STORE.filter = $(".ratings option:selected").val()),
                  v.render();
              }),
              $("main").on("click", ".delete", function () {
                event.preventDefault(),
                  ...
                  o.STORE.filtering,
                  o.STORE.error;
                const e = $(this).attr("data-clicked-id");
              ...
              $("main").on("submit", ".form-submit", function (e) {
                e.preventDefault(),
                  (o.STORE.error = null),
                  (o.STORE.adding = !1),
                  (o.STORE.filtering = !1),
